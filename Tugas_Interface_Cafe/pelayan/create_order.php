...
<head>
    <meta charset="UTF-8">
    <title>Pelayan - Buat Pesanan</title>
    ...
    <div class="pos-container">
        ...
        <div class="menu-area">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                ...
                <div>
                    <a href="dashboard.php" class="btn btn-outline" style="margin-right: 1rem;">Kembali</a>
                </div>
            </div>
        ...
        <div class="cart-area">
            ...
            <div class="cart-footer">
                ...
                <button onclick="processOrder()" class="btn btn-primary" style="width: 100%;">Kirim Pesanan</button>
            </div>
        </div>
    </div>
